...
public class FallbackIntentHandlerTest {
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains(Constants.UNKNOWN_QUERY));
        assertTrue(response.getReprompt().toString().contains(Constants.UNKNOWN_QUERY));
    }
}
